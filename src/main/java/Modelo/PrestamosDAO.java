...
public class PrestamosDAO {
	...
	public ArrayList<PrestamosDTO> todosPrestamos(){
		
		PrestamosDTO pre=null;
		...
		res=ps.executeQuery();
		while(res.next()) {
			pre=new PrestamosDTO(res.getInt(1),res.getString(2),res.getString(3),res.getString(4),res.getString(5));
			lista.add(pre);
		}
